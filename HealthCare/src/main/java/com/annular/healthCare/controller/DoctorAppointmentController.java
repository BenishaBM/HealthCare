...
public class DoctorAppointmentController {
	...
	public ResponseEntity<?> getAllPatientPharamcyBypatientIdAndDate(
	        @RequestParam("patientId") Integer  patientId,@RequestParam("currentDate")String currentDatae,@RequestParam("appointmentId")Integer appontmentId) {
	    try {
	        logger.info("getAllPatientPharamcyBypatientIdAndDate request for createdOn: {}, appointmentType: {}", patientId);
	        
	       
	        return doctorAppoitmentService.getAllPatientPharamcyBypatientIdAndDate(patientId,currentDatae,appontmentId);
	    } catch (Exception e) {
	...
	public ResponseEntity<?> getAllPatientMedicalTestBypatientIdAndDate(
	        @RequestParam("patientId") Integer  patientId,@RequestParam("currentDate")String currentDatae,@RequestParam("appointmentId")Integer appointmentId) {
	    try {
	        logger.info("getAllPatientMedicalTestBypatientIdAndDate request for createdOn: {}, appointmentType: {}", patientId);
	        
	       
	        return doctorAppoitmentService.getAllPatientMedicalTestBypatientIdAndDate(patientId,currentDatae,appointmentId);
	    } catch (Exception e) {
